...
public abstract class NioSslPeer {
    private static String TAG = "NioSslPeer";
    ...
    *      */
    protected boolean doHandshake(SocketChannel socketChannel, SSLEngine engine) throws IOException {
        ...
        while (handshakeStatus != HandshakeStatus.FINISHED && handshakeStatus != HandshakeStatus.NOT_HANDSHAKING) {
            ...
            case NEED_TASK:
                ...
                break;
            case FINISHED:
                Log.d("HANDSHAKING: ", "FINISHED!");
                break;
            case NOT_HANDSHAKING:
                Log.d("HANDSHAKING: ", "NOT_HANDSHAKING!");
                break;
            default:
    ...
    protected void finalize() throws Throwable {
        myAppData.clear();myNetData.clear();peerAppData.clear();peerNetData.clear();
        super.finalize();
    }
}
